...
def rf_llm_fine_tune(x_train, y_train, x_test, y_test):
    """
...
def cot(x_test, pred_label, confidence):
    ...
    cot_template = f"""
                        You are a physical activity classifier. 
                        Determine whether a ML classifier correctly classified this data.
                        ...
                        Predicted label = {pred_label_unencoded}
                        Confidence = {confidence}
                        
                        This sample was considered unreasonable because the confidence between top predicted classes was too close.
                        
                        Think step by step:
                        1. Evaluate movement intensity
                        2. Evaluate rhythmic motion
                        3. Compare features with interpretation guide
                        4. Decide whether ML prediction is correct
